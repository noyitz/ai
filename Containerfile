...
# Optional extra cargo features for the release binary (shadow/ops lanes only;
# the dogfood image sets PRAXIS_AI_FEATURES=gcp-adc-filter for the vertex
# pilot). Empty default preserves the shipped build exactly.
ARG PRAXIS_AI_FEATURES=""
